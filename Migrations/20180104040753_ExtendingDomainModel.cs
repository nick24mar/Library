...
{
    public partial class ExtendingDomainModel : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CheckoutHistoriess", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CheckoutHistoriess_LibraryAssets_LibraryAssetId",
                        column: x => x.LibraryAssetId,
                        principalTable: "LibraryAssets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CheckoutHistoriess_LibraryCards_LibraryCardId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CheckoutHistoriess_LibraryAssetId",
                table: "CheckoutHistoriess",
                column: "LibraryAssetId");

            migrationBuilder.CreateIndex(
                name: "IX_CheckoutHistoriess_LibraryCardId",
                table: "CheckoutHistoriess",
                column: "LibraryCardId");
